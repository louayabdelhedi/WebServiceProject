...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\WebService\\WebServiceBundle\\Entity'))), 'WebService\\WebServiceBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('WebServiceWebServiceBundle' => 'WebService\\WebServiceBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fcbf2782657ce8b7e2d0002834ef8281a8f3ffa4b593c3c1afbfaf9cf1ba286f');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\WebService\\WebServiceBundle/Resources/views'), 'WebServiceWebService');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.java.bin' => 'C:\\Program Files\\Java\\jdk1.7.0_75\\bin\\java.EXE',

...
use WebService\WebServiceBundle\Entity\Test;
use WebService\WebServiceBundle\Form\TestType;
...
class TestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WebServiceWebServiceBundle:Test')->findAll();
     ...
     * @Method("POST")
     * @Template("WebServiceWebServiceBundle:Test:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebServiceWebServiceBundle:Test')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("WebServiceWebServiceBundle:Test:edit.html.twig")
     */
